...
class DownloaderChatServiceImplTest {
    @Mock
    TelegramLongPollingBot botMocked;
    @InjectMocks
    DownloaderChatServiceImpl downloaderChatService;
    
    @Nested
    @DisplayName("Testing downloadDocument method")
    class DownloadDocumentTest {
        ...
        public void whenDocDownloadsSuccessfully() throws TelegramApiException {
            ...
            File resultFile = downloaderChatService.downloadDocument(document);
        ...
        public void whenExecuteMethodThrowsExceptionThenRuntimeExceptionRethrows() throws TelegramApiException {
            ...
            document.setFileName(fileName);
            document.setFileId(fileId);
            Throwable exc = assertThrows(RuntimeException.class, () -> downloaderChatService.downloadDocument(document));
